...
public class sem4 {
    ...
    public static void main(String[] args) {
        ...
        // Создаем очереди
        Deque<String> list_1 = new LinkedList<>(Arrays.asList("2","2","1"));
        Deque<String> list_2 = new LinkedList<>(Arrays.asList("6","4","-"));
        Deque<String> list_3 = new LinkedList<>(Arrays.asList("4","2"));
        Deque<String> list_4 = new LinkedList<>(Arrays.asList("1","2","2"));
